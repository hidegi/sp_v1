#ifndef SP_CONFIG_H_INCLUDED
#define SP_CONFIG_H_INCLUDED
...
#define SP_COMPILE_VERSION 14   ///build generated symbol!! pls change later..
...
#if defined(__cpp_initializer_list) && (__cpp_initializer_list >= 200806L)
    #define SP_INITIALIZER_LIST_SUPPORTED 1
#endif
